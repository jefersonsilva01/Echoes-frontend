...
const SocialIcons = (props) => {
  ...
  return (
    <SocialIconsContainer
      like={props.user.likes.includes(content._id, 0).toString()}
      bookmark={props.user.bookmarks.includes(content._id, 0).toString()}
    >
      <div id="heart">
        {
          props.user.likes.includes(content._id, 0)
            ? (
              <svg
                onClick={() => { unlikeArticle(content._id, props.user._id) }}
            ...
            : (
              <svg
                onClick={
                  props.user
                    ? () => likeArticle(content._id, props.user._id)
                    : undefined
                }
      ...
      <div id="bookmarks">
        {
          props.user.bookmarks.includes(content._id, 0)
            ? (
              <svg
                onClick={unBookmark}
                width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
